...
class GreyIvyTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the length of the [GreyIvyTabBarView.children] list.
  ...
  void scrollToCurrentIndex() {
    final state = StateSet.of<GreyIvyTabBar, _GreyIvyTabBarState>();
    if (state != null) {
      state._handleTabControllerTick();
    }
  }

  @override
  State createState() => _GreyIvyTabBarState();
}

class _GreyIvyTabBarState extends State<GreyIvyTabBar> with StateSet {
  ...
  bool get _controllerIsValid =>
      _controller != null && _controller.animation != null;
  ...
  @override
  void didUpdateWidget(GreyIvyTabBar oldWidget) {
...
class _IndicatorPainter extends CustomPainter {
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    final Rect rect =
        Rect.fromLTWH(tabLeft, 0, tabRight - tabLeft, tabBarSize.height);
...
class GreyIvyTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const GreyIvyTabBarView({
    Key key,
  ...
  @override
  _GreyIvyTabBarViewState createState() => _GreyIvyTabBarViewState();
}

class _GreyIvyTabBarViewState extends State<GreyIvyTabBarView> with StateSet {
  TabController _controller;
  ...
  @override
  void didUpdateWidget(GreyIvyTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.controller != oldWidget.controller) {
      _updateTabController();
    }
